...
const BloodDonationRegistration = () => {
  ...
  const [currentStep, setCurrentStep] = useState<Step>(STEPS.SELECT_DATE)
  ...
  const renderStep = () => {
    switch (currentStep) {
      case STEPS.SELECT_DATE:
        return <SelectDateStep dateRange={dateRange} setDateRange={setDateRange} setCurrentStep={setCurrentStep} />;
