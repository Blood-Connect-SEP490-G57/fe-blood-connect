    ...
    <div className='container relative min-h-screen flex items-center justify-center'>
      <Card className='w-full max-w-md p-6 text-center space-y-6'>
        <div className='space-y-2'>
          ...
          <h2 className='text-2xl font-semibold tracking-tight'>Oops! Trang này không tồn tại</h2>
          <p className='text-muted-foreground'>Có vẻ như trang bạn đang tìm kiếm không tồn tại hoặc đã bị di chuyển.</p>
        </div>
