    ...
    <div className='space-y-6 mx-auto sm:p-4 p-2'>
        ...
        <CardContent className='p-5'>
          <div className='space-y-4'>
            ...
            <p>
              ...
              mình bất kỳ lúc nào trong mục thông tin cá nhân.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-end'>
        <button
          ...
          className='bg-red-600 hover:bg-red-700 text-white p-4 rounded-xl transition-colors flex items-center justify-center gap-2'
        >
          <div>
