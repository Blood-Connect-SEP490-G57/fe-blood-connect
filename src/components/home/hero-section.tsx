        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-white z-10">
            ...
            <p className="text-lg mb-8 text-red-50 leading-relaxed max-w-xl">
              Mỗi giọt máu hiến tặng là một cơ hội để cứu sống người khác. 
              Hãy chung tay vì một cộng đồng khỏe mạnh và nhân ái.
            </p>
  ...
  return (
    <div className="lg:w-1/2 relative">
      ...
      {floatingCards.map((card, index) => (
        <div key={index} className={`absolute ${card.position} bg-white p-4 rounded-lg shadow-xl animate-bounce-slow ${index > 0 ? 'delay-150' : ''}`}>
