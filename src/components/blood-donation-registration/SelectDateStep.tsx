  ...
  return (
    <Card className='border-none shadow-lg'>
      <CardHeader>
        ...
        <CardDescription>Chọn khoảng thời gian bạn có thể tham gia hiến máu</CardDescription>
      </CardHeader>
        ...
        <div className='flex flex-wrap gap-4'>
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {dateRange.from ? format(dateRange.from, 'PPP', { locale: vi }) : <span>Chọn ngày bắt đầu</span>}
              </Button>
            </PopoverTrigger>
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                <CalendarIcon className='mr-2 h-4 w-4' />
                {dateRange.to ? format(dateRange.to, 'PPP', { locale: vi }) : <span>Chọn ngày kết thúc</span>}
              </Button>
            </PopoverTrigger>
            <PopoverContent className='w-auto p-0' align='start'>
              <Calendar
