          ...
          <div className="text-center mt-6 space-y-4">
            ...
            >
              <p className="text-red-700 text-sm">
                <span className="font-medium">Lưu ý:</span> Vui lòng kiểm tra email và đến đúng giờ hẹn. 
                Hãy nhớ mang theo CMND/CCCD và đảm bảo bạn đã nghỉ ngơi đầy đủ trước khi hiến máu.
              </p>
            </motion.div>
